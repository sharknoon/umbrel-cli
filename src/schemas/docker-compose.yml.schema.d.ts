...
export type DefinitionsDeployment = {
  ...
  rollback_config?: {
    parallelism?: number;
    delay?: DurationFormat;
    failure_action?: string;
    monitor?: DurationFormat;
...
export type PortFormat = number;
export type PortPublishedFormat = string;
/**
...
export type DefinitionsNetwork = {
  ...
  ipam?: {
    driver?: string;
    config?: {
      subnet?: Ipv4SubnetFormat | Ipv6SubnetFormat;
      ip_range?: string;
      gateway?: string;
      aux_addresses?: {
        /**
...
export type Ipv4SubnetFormat = string;
export type Ipv6SubnetFormat = string;
export type Network = {
  name?: string;
  driver?: string;
  driver_opts?: {
...
export interface DefinitionsService {
  ...
  ports?: (
    ...
    | {
        ...
        name?: string;
        /**
         * host: For publishing a host port on each node, or ingress: for a port to be load balanced. Defaults to ingress.
         */
        mode?: string;
        /**
        ...
        target?: number;
        /**
         * The publicly exposed port. It is defined as a string and can be set as a range using syntax start-end. It means the actual port is assigned a remaining available port, within the set range.
         */
        published?: PortFormat | PortPublishedFormat;
        /**
         * The port protocol (tcp or udp). Defaults to tcp
         */
        protocol?: string;
        /**
  ...
  sysctls?: ListOrDict;
  stdin_open?: boolean;
  stop_grace_period?: DurationFormat;
  stop_signal?: string;
  storage_opt?: {
    [k: string]: unknown;
  };
...
export interface DefinitionsHealthcheck {
  disable?: boolean;
  interval?: DurationFormat;
  retries?: number;
  test?: string | string[];
  timeout?: DurationFormat;
  start_period?: DurationFormat;
  start_interval?: DurationFormat;
  /**
